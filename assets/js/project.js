...
const projects = [
  {
    ...
    description: "As part of team, I played a pivotal role in this Video Analysis System for a prominent Japanese news TV channel. It autonomously identifies and logs various anomalies, including sound errors, black screen incidents, freezing frames, and text errors, ensuring the highest level of broadcast quality.",
  ...
  },
  {
    ...
    description: "A desktop application offers streamlined parking solutions for vehicles in Bangladesh. Using Computer Vision, it captures license plate details upon entry, storing them in AWS. At exit, it automatically calculates stay duration and generates a bill. I was one of the team member of this project.",
  ...
  },
  {
    ...
    tagimg: "https://cdn.iconscout.com/icon/free/png-512/react-1-282599.png",
    Previewlink: "",
    Githublink: "https://github.com/shaiful019/RBMS",
  },
  {
    title: "CONTENT MANAGEMENT SYSTEM",
    cardImage: "assets/images/project-page/cms.jpg",
    description: "I was responsible for designing and implementing this CMS using .Net Core along with another Trainee Software Engineer during my internship period.",
    tagimg: "https://miro.medium.com/max/2800/0*U2DmhXYumRyXH6X1.png",
    Previewlink: "",
    Githublink: "https://github.com/shaiful019/CMS",
  },
  // {
      ...
      (output += `       
        <div class="column skill-card card" style="margin: 15px"data-aos="zoom-in-up" data-aos-easing="linear" data-aos-delay="300" data-aos-duration="600" >
          <div class="wrapper" style="background: url(${cardImage}) center / cover no-repeat;">
            ...
            <div class="data">
            <h1 class="title-div" align="justify">${title}</h1>
